...
try:
    from analyzers.protocols.tcp.streams import reconstruct_tcp_streams as _reconstruct_tcp_streams_new
    reconstruct_tcp_streams = _reconstruct_tcp_streams_new
except Exception:
